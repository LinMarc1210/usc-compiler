...
void ASTSwitchStmt::addStmt(std::shared_ptr<ASTCaseDefaultStmt> stmt) noexcept
{
	this->case_default_stmts.push_back(stmt);
}

void ASTCaseDefaultStmt::addStmt(std::shared_ptr<ASTStmt> stmt) noexcept
{
	this->mStmts.push_back(stmt);
}
